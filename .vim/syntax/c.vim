...
syn keyword	cStatement	goto break return continue as iop kharge jop JOP IOP ici1 ici2 imomap ief multci lroot iroot LYS
syn keyword	cLabel		case default mapthr iprint mprint kitscf NSTEP FVS FHOP FSTAT FSAV AN_CC RESTART CUTHOP FOL_STAT
syn keyword	cConditional	if else switch iconv
syn keyword	cRepeat		while for do iprec
