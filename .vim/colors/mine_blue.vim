...
hi Normal		guifg=yellow	guibg=DarkGrey	ctermfg=yellow	ctermbg=DarkGrey
hi NonText		guifg=magenta	ctermfg=lightMagenta
hi comment		guifg=gray		ctermfg=gray	ctermbg=DarkGrey	gui=bold 
hi constant		guifg=cyan		ctermfg=cyan
hi identifier	guifg=gray		ctermfg=Grey
hi statement	guifg=white		ctermfg=white	ctermbg=DarkGrey	gui=none
hi preproc		guifg=green		ctermfg=green
hi type			guifg=orange	ctermfg=lightRed	ctermbg=DarkGrey
hi special		guifg=magenta	ctermfg=lightMagenta	ctermbg=DarkGrey
hi Underlined	guifg=cyan		ctermfg=cyan	gui=underline	cterm=underline
hi label		guifg=yellow	ctermfg=yellow
hi operator		guifg=orange	gui=bold	ctermfg=lightRed	ctermbg=DarkGrey

hi ErrorMsg		guifg=orange	guibg=DarkGrey	ctermfg=lightRed
hi WarningMsg	guifg=cyan		guibg=DarkGrey	ctermfg=cyan	gui=bold
hi ModeMsg		guifg=yellow	gui=NONE	ctermfg=yellow
hi MoreMsg		guifg=yellow	gui=NONE	ctermfg=yellow
hi Error		guifg=red		guibg=DarkGrey	gui=underline	ctermfg=red
